...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-7xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ __('messages.breathing.title') }}</h1>
        <p class="text-gray-600 mb-8">{{ __('messages.breathing.subtitle') }}</p>

        <!-- Filtres -->
        <div class="bg-white rounded-2xl p-6 sm:p-8 shadow-lg mb-8">
            ...
            <form action="{{ route('breathing.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="category" id="category" class="w-full rounded-xl border-2 p-3 border-gray-200 focus:border-gray-900 transition-colors duration-200 text-base">
                ...
                <div class="flex items-end">
                    <button type="submit" class="w-full bg-gray-900 text-nav px-6 py-3 rounded-xl font-medium hover:bg-gray-800 transition-colors duration-200 text-base">
