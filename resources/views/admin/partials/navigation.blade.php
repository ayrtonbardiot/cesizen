<nav class="bg-nav shadow-lg" role="navigation" aria-label="{{ __('messages.navigation.admin') }}">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-24">
            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-4">
                ...
                <a href="{{ route('admin.settings') }}" class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('admin.settings') ? 'bg-white text-gray-900' : '' }}">
    ...
    <div class="sm:hidden hidden" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="{{ route('admin.settings') }}" class="block px-3 py-2 rounded-md text-base font-medium {{ request()->routeIs('admin.settings') ? 'bg-nav text-gray-900' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50' }}">
                {{ __('messages.settings.title') }}
            </a>
